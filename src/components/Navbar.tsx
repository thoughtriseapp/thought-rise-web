...
const navLinks = [
  ...
  { name: 'Hearing Your Name', href: '/hearing-your-name' },
...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled || isSubPage ? 'bg-primary/80 backdrop-blur-md shadow-sm' : 'bg-transparent'}`}>
